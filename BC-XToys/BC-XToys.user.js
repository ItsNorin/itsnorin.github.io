...
console.log("You are using an out of date version of BC-XToys due repository changes, sorry :P");
console.log("Please update your script and loader manually from https://github.com/ItsNorin/Bondage-Club-XToys-Integration");
...
+ 'You are using an out of date version of BC-XToys due repository changes, sorry :P. Please update your loader or script manually from https://github.com/ItsNorin/Bondage-Club-XToys-Integration';
